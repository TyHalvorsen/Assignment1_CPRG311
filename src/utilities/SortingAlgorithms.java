...
public class SortingAlgorithms {
    ...
    public void quickSort(Debug debugLevel) {
        ...
        doQuickSort(inputArray, 0, SHAPE_ARRAY_SIZE - 1);

        long endTime = System.nanoTime(); // time ended
        System.out.println("Time Taken In Sorting Method in ms: " + (endTime - startTime) / 1000000);
    }

    private void doQuickSort(Shape[] array, int start, int end) {

        int firstIndexOfRightPart = partition(array, start, end);
        ...
        if (start < firstIndexOfRightPart - 1) {
            ...
            doQuickSort(array, start, firstIndexOfRightPart - 1);
        }
        ...
        if (firstIndexOfRightPart < end) {
            ...
            doQuickSort(array, firstIndexOfRightPart, end);
        }
    }

    private int partition(Shape[] array, int start, int end) {
     ...
     *
     * Post-Condition: both sub arrays are compared via first index then merged
     * into one array
     *
     * @param array
     * @param leftArray
     ...
     *
     * Post-Condition: currentIndex is swaped with indexToSwap in the given
     * array, array is then returned
     *
     * @param array
     * @param currentIndex
     * @param indexToSwap
